...
class ChunkLoadingSystem:
    ...
    def queue_chunks_around_player(self, player_pos, facing_dir=None):
        """根据玩家位置和朝向，智能加载周围区块"""
        # 获取玩家所在区块坐标
        ...
        # 使用螺旋序列加载其他区块
        for dx, dz in self.preload_spiral:
    ...
    def process_queue(self, max_chunks=3, chunk_generator=None):
        """处理加载队列，加载指定数量的区块"""
